export default {
	...
	register: {
		...
		usernameForbidden: "That username is not available",
		usernameBadFormat: "3 to 30 characters: letters, numbers, dot, hyphen and underscore, starting and ending with a letter or number",
	...
	errors: {
		...
		FORBIDDEN_USERNAME: "That username is not available. Please pick another one.",
		// Both of the sign-up 429s. The server message carries the concrete wait and wins over this.
		RATE_LIMIT_EXCEEDED: "Too many attempts from this connection. Wait a while and try again; the limit is per network, so it can reach you if someone else shares it.",
		REGISTER_QUOTA_EXCEEDED: "Several accounts were already created from this connection in the last hour. Please try again later.",
